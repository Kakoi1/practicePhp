...
<div id="container">
    ...
    ?>
                <form action="includes/buy_prod.php" method="post">
                    <input type="hidden" name="pid" value="<?php echo $userData['product_id']; ?>">
                    <label for="name">Name:</label>
                    <input type="text" name="pname" id="pname" value="<?php echo $userData['product_name']; ?>" readonly>

                    <label for="email">Email:</label>
                    <input type="text" name="pstock" id="pstock" value="<?php echo $userData['product_stock']; ?>" readonly>
                    ...
                    <div class="button-container">
                        <button type="submit" class="update-button">Buy</button>
                    </div>
                </form>
    <?php
            } else {
